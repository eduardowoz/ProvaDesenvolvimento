...
//     tarefa.Preco = tarefaAtualizada.Preco;
//     await context.SaveChangesAsync();
//     return Results.Ok("tarefa atualizado com sucesso.");
// });

app.MapPut("/tarefas/alterar/{id}", async (int id, Status produtoAtualizado, AppDataContext context) =>
{
    ...
    Tarefa.EmAndamento = tarefaAtualizada.EmAndamento;
